...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='BHP Net Tool',
                                     ...
                                     epilog=textwrap.dedent(
                                         ...
                                         # ファイルのアップロード
                                         netcat.py -t 192.168.1.108 -p 5555 -l -u=top_secret.txt
                                         # コマンドの実行
                                         netcat.py -t 192.168.1.108 -p 5555 -l -e=\"cat /etc/passwd\"
                                         # 通信先サーバーの135番ポートに文字列を送信
                                         echo 'hi admin. how are you?' | ./netcat.py -t 192.168.1.108 -p 135
                                         # サーバーに接続
                                         netcat.py -t 192.168.1.108 -p 5555
                                         '''
                                     ))
    parser.add_argument('-c', '--command', action='store_true', help='対話シェルの初期化')
